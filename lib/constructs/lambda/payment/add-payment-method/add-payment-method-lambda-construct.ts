...
export class AddPaymentMethodLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: AddPaymentMethodLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/payment/add-payment-method/add-payment-method-lambda.ts');
    this.function = new NodejsFunction(this, 'AddPaymentMethodFunction', {
