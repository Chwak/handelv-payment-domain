...
export class CreateRefundLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CreateRefundLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/payment/create-refund/create-refund-lambda.ts');
    this.function = new NodejsFunction(this, 'CreateRefundFunction', {
