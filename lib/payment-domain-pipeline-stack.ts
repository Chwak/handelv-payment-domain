 ...
 * 
 * Self-contained pipeline infrastructure for the payment-domain domain:
...
export interface PaymentDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class PaymentDomainPipelineStack extends cdk.Stack {
  public readonly artifactBucket: s3.Bucket;

  constructor(scope: Construct, id: string, props: PaymentDomainPipelineStackProps) {
